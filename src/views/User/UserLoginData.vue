              ...
              <v-form ref="form">
                ...
                <v-row>
                  ...
                  <v-col cols="12" md="4">
                    ...
                    <v-text-field class="textfield" background-color="#f0f2f7" placeholder="กรอกนามสกุล (อังกฤษ)"
                ...
                <v-row cols="12" md="12">
                  <v-col>
                    ...
                    <v-text-field class="textfield" background-color="#f0f2f7"
                      placeholder="กรอกที่อยู่ในการจัดส่งเอกสาร" outlined></v-text-field>
                  </v-col>
                </v-row>
                <v-row cols="12" md="12">
...
export default {
  ...
  methods: {
    ...
    removePhoto() {
      this.user.photo = 'https://picsum.photos/200/300'; // รีเซ็ตเป็นค่าเริ่มต้น
    },
    resetForm() {
      this.user = {
        photo: 'https://picsum.photos/200/300',
