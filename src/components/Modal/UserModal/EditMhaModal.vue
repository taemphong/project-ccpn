    ...
    methods: {
        ...
        async confirmEdit() {
            ...
            const payload = {
                ...
                mha_address: this.editedAddress.mha_address,
                mha_province: this.editedAddress.mha_province,
                mha_amphoe: this.editedAddress.mha_amphoe,
                mha_district: this.editedAddress.mha_district,
                mha_zipcode: this.editedAddress.mha_zipcode,
            };

            try {
                const response = await axios.post('http://localhost:8002/ccph/api/update-house-address', payload);
