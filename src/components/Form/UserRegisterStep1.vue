  ...
  <v-container>
    ...
    <v-row>
      <v-col cols="12" md="12">
        ...
        <v-container fluid>
          <v-checkbox v-model="selected2" label="สำเนาทะเบียนบ้าน 1 ฉบับ" value="สำเนาทะเบียนบ้าน 1 ฉบับ"></v-checkbox>
          ...
          <div style="margin-left: 30px;">
            <v-checkbox v-model="selected2" label="Transcript" value="Transcript"></v-checkbox>
            <v-checkbox v-model="selected2" label="ปริญญาบัคร" value="ปริญญาบัคร"></v-checkbox>
            <v-checkbox v-model="selected2" label="อนุปริญญาบัคร" value="อนุปริญญาบัคร"></v-checkbox>
          ...
          <v-checkbox v-model="selected2" label="ใบรับรองแพทย์" value="ใบรับรองแพทย์"></v-checkbox>
          <v-checkbox v-model="selected2" label="สำเนาหลักฐานอื่น ๆ(ถ้ามี)"
